...
class $EvaluationsTable extends Evaluations
  ...
  static const VerificationMeta _scaleVersionMeta = const VerificationMeta(
    'scaleVersion',
  );
  @override
  ...
  static const VerificationMeta _caseDescriptionMeta = const VerificationMeta(
    'caseDescription',
  );
  @override
  ...
  EvaluationRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return EvaluationRow(
      ...
      scaleVersion: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}scale_version'],
      )!,
      caseDescription: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}case_description'],
      )!,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final EvaluationsDao evaluationsDao = EvaluationsDao(
    this as AppDatabase,
  );
