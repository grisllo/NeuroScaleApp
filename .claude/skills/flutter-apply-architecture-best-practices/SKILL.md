...
### Task Progress
- [ ] **Step 1: Define Domain Models.** Create immutable data classes for the feature.
...
- [ ] **Step 4: Apply Conditional Logic (Domain Layer).**
  - *If complex data transformation or cross-repository logic:* Create a Use Case class.
  - *If simple CRUD operation:* Skip to Step 5.
...
- [ ] **Step 7: Inject Dependencies.** Register the new Service, Repository, and ViewModel in the dependency injection container.
