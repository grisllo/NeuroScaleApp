...
Status: **v1.0.0** released on 2026-05-13. 204 tests green, `flutter analyze` at 0 issues, ~85 h of active development. Web production: <https://grisllo.github.io/NeuroScaleApp/>.
