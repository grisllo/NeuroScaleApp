...
gantt
    ...
    Filtros + busqueda + paginacion (30m)       :done, f2a2, 2026-04-27, 1d
    Graficos fl_chart (45m)                     :done, f2a3, 2026-04-27, 1d
    mRS 0-6 (20m)                               :done, f2a4, 2026-04-27, 1d
    Barthel Index 0-100 (20m)                   :done, f2a5, 2026-04-27, 1d
    ...
    11.1 Hash avatar + layout web (2h)          :done, f11a, 2026-05-12, 1d
    11.2 Auth card navy + tema calido (1h)      :done, f11b, 2026-05-12, 1d
    ...
    12.4 Fixes movil - icono + nombre (0.5h)    :done, f12d, 2026-05-12, 1d
    12.5 Algoritmos - jerarquia + UX (0.5h)     :done, f12e, 2026-05-12, 1d

    section Fase 13 - Fixes UX evaluaciones
    13.1 Paciente obligatorio + fix case_desc (1h) :done, f13a, 2026-05-13, 1d
    13.2 Disclaimer SnackBar primera vez (0.5h) :done, f13b, 2026-05-13, 1d
    13.3 Fix FilledButton apagado (0.1h)        :done, f13c, 2026-05-13, 1d
    13.4 UX pacientes - tab + cabecera (0.1h)   :done, f13d, 2026-05-13, 1d
    13.5 Toast disclaimer web + swipe movil (0.5h) :done, f13e, 2026-05-13, 1d
    13.6 NavigationRail fondo diferenciado (0.1h) :done, f13f, 2026-05-13, 1d
    13.7 Ordenacion evaluaciones (0.2h)         :done, f13g, 2026-05-13, 1d
    13.8 PatientAvatar iniciales inteligentes (0.2h) :done, f13h, 2026-05-13, 1d
    13.9 Spinner carga web + homepage (0.2h)    :done, f13i, 2026-05-13, 1d
    13.10 Fix produccion web BOM + URL (2.5h)   :done, f13j, 2026-05-13, 1d

    section Fase 14 - Auditoria y produccion v1.0.0
    14.Audit Auditoria multi-dim + plan (0.5h)  :done, f14au, 2026-05-13, 1d
    14.A Criticos produccion RLS+Sentry (0.5h)  :done, f14a,  2026-05-13, 1d
    14.B Tokens spacing/radii (0.5h)            :done, f14b,  2026-05-13, 1d
    14.C Accesibilidad Semantics+tooltips (0.1h) :done, f14c,  2026-05-13, 1d
    14.D Tests widget PatientAvatar (0.1h)      :done, f14d,  2026-05-13, 1d
    14.E Documentacion RELEASE+SECURITY (0.1h)  :done, f14e,  2026-05-13, 1d
    14.F Cobertura + ROADMAP + tag v1.0.0 (0.1h) :done, f14f,  2026-05-13, 1d

    section Post v1.0.0 - Mantenimiento
    ROADMAP restructura + auditoria docs (0.25h) :done, pv1a, 2026-05-14, 1d
    Licencia propietaria + badge CI (0.25h)     :done, pv1b, 2026-05-14, 1d
    Auth screens fondo tema + teal (0.5h)       :done, pv1c, 2026-05-14, 1d
    Fix inputs dark mode fillColor (0.1h)       :done, pv1d, 2026-05-14, 1d
    Pulido integral 9 docs (0.75h)              :done, pv1e, 2026-05-14, 1d
